    ...
    */
    ...
    var ToolbarSection = /** @class */ (function (_super) {
        ...
        ToolbarSection.prototype.render = function () {
            var _this = this;
            var children = this.props.widgetGroups.map(function (widgetGroup) { console.log(widgetGroup); return _this.renderWidgetGroup(widgetGroup); });
    ...
    var TableDateCell = /** @class */ (function (_super) {
        ...
        TableDateCell.prototype.render = function () {
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.dayHeaderClassNames, content: options.dayHeaderContent, defaultContent: renderInner$1, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, function (rootElRef, customClassNames, innerElRef, innerContent) { 
                // format week table header day label
                var weekDayName = innerContent.slice(0, 1);
                var weekDay = innerContent.split('.')[1];
                var newValue = `${weekDayName.toUpperCase().trim()} - ${weekDay.trim()}`;
    ...
    var SimpleScrollGrid = /** @class */ (function (_super) {
        ...
        SimpleScrollGrid.prototype.renderChunkTd = function (sectionConfig, microColGroupNode, chunkConfig, isHeader) {
            ...
            return createElement(isHeader ? 'th' : 'td', {
                ...
                createElement(Scroller, { ref: this.scrollerRefs.createRef(sectionKey), elRef: this.scrollerElRefs.createRef(sectionKey), overflowY: 'auto' /* natural height? */, maxHeight: sectionConfig.maxHeight, liquid: isLiquid, liquidIsAbsolute // because its within a harness
                    : true }, content)));
        };
